    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <h4 class="mt-3 me-2" style="color: white; font-size: 21.5px; white-space: nowrap; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                ...
                <div class="theme-toggle d-flex gap-2 align-items-center mt-2">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" class="iconify iconify--mdi" width="20" height="20" viewBox="0 0 24 24" style="margin-left: -8px;">
            ...
            <ul class="menu">
                ...
                @else
                    ...
                    <li class="sidebar-item {{ request()->is('user/activities*') ? 'active' : '' }}">
                        <a href="{{ route('user.activities.index') }}" class="sidebar-link">
                            <i class="bi bi-journal-bookmark-fill"></i>
                            <span>Data Kegiatan</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ request()->is('user/surat-masuk*') ? 'active' : '' }}">
                        <a href="{{ route('user.surat-masuk.index') }}" class="sidebar-link">
                            <i class="bi bi-envelope"></i>
                            <span>Data Surat Masuk</span>
                        </a>
                    </li>
